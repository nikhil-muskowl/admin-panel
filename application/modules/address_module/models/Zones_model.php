...
class Zones_model extends CI_Model {
    ...
    private $column_order = array(null, 'country', 'name', 'code', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('country', 'name', 'code', 'status', 'created_date', 'modified_date');
