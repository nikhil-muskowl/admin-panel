...
class Countries_api extends Restserver\Libraries\REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->countries_model->getTables();
        ...
        foreach ($list as $object) :
            $result[] = array(
                'id' => $object['id'],
                'name' => $object['name'],
                'iso_code_2' => $object['iso_code_2'],
                'iso_code_3' => $object['iso_code_3'],
                'address_format' => $object['address_format'],
                'postcode_required' => $object['postcode_required'],
        ...
        endforeach;
        $this->data['draw'] = $draw;
        $this->data['recordsTotal'] = $this->countries_model->countAll();
        $this->data['recordsFiltered'] = $this->countries_model->countFiltered();
    ...
    public function list_post() {
        ...
        foreach ($list as $object) :
            $action = '';
            $action .= '<a class="btn btn-sm btn-primary" href="' . base_url('address_module/countries/form/' . $object['id']) . '" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
    ...
    public function detail_post($id) {
        ...
        $object = $this->countries_model->getById($id);
    ...
    public function save_post() {
        $this->data = array();
        $this->_validation();
        $result = $this->countries_model->postData();
        if ($result):
            $this->data['status'] = TRUE;
    ...
    public function delete_get($id) {
        $this->data = array();
        $result = $this->countries_model->deleteById($id);
        if ($result) {
            $this->data['status'] = TRUE;
