...
class User_complains extends MX_Controller {
    ...
    public function index() {
        $this->data = array();
        $this->data['ajax_list'] = base_url('user_module/api/user_complains_api/list');
        $this->data['ajax_delete'] = base_url('user_module/api/user_complains_api/delete');
        $this->data['ajax_form'] = base_url('user_module/user_complains/form');
        ...
        $this->load->view('user_module/user_complains/list', $this->data);
    ...
    public function form($id = NULL) {
        ...
        $this->data['ajax_list'] = base_url('user_module/user_complains');
        $this->data['ajax_save'] = base_url('user_module/api/user_complains_api/save');
        $this->data['ajax_image_form'] = base_url('user_module/user_complains/image_form/');
        ...
        $this->load->view('admin/common/navbar', $this->data);
        $this->load->view('admin/common/sidebar', $this->data);
        $this->load->view('user_module/user_complains/form', $this->data);
