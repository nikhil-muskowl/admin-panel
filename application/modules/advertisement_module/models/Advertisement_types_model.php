...
class Advertisement_types_model extends CI_Model {

    private $table = 'advertisement_types';
    private $table_view = 'advertisement_types_view';
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('advertisement_type_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('advertisement_type_details');
            endforeach;
        endif;
    }
    ...
    public function details($id) {
        $result = array();
        $this->db->from('advertisement_type_details');
        $this->db->where('id', $id);
        $query = $this->db->get();
