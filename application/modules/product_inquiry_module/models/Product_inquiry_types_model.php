...
class Product_inquiry_types_model extends CI_Model {

    private $table = 'p_inquiry_types';
    private $table_view = 'p_inquiry_types_view';
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('p_inquiry_type_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('p_inquiry_type_details');
            endforeach;
        endif;
    }
    ...
    public function details($id) {
        $result = array();
        $this->db->from('p_inquiry_type_details');
        $this->db->where('id', $id);
        $query = $this->db->get();
