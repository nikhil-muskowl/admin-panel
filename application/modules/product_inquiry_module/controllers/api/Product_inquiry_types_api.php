...
class Product_inquiry_types_api extends Restserver\Libraries\REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->product_inquiry_types_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->product_inquiry_types_model->countAll();
        $this->data['recordsFiltered'] = $this->product_inquiry_types_model->countFiltered();
    ...
    public function list_post() {
        ...
        foreach ($list as $object) :
            $action = '';
            $action .= '<a class="btn btn-sm btn-primary" href="' . base_url('product_inquiry_module/product_inquiry_types/form/' . $object['id']) . '" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
    ...
    public function detail_get($id) {
        $this->data = array();
        $object = $this->product_inquiry_types_model->getById($id);
        if ($object):
            $result[] = array(
                'id' => $object['id'],
                'title' => $object['title'],
    ...
    public function save_post() {
        $this->data = array();
        $this->_validation();
        $result = $this->product_inquiry_types_model->postData();
        if ($result):
            $this->data['status'] = TRUE;
    ...
    public function delete_get($id) {
        $this->data = array();
        $result = $this->product_inquiry_types_model->deleteById($id);
        if ($result) {
            $this->data['status'] = TRUE;
