...
class Stories_model extends CI_Model {
    ...
    private $column_order = array(null, 'title', 'totalLikes', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('title', 'totalLikes', 'status', 'created_date', 'modified_date');
