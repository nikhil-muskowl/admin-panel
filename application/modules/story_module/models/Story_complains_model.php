...
class Story_complains_model extends CI_Model {

    private $table = 'story_complains';
    private $table_view = 'story_complains_view';
    private $column_order = array(null, 'title', 'story_title', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('title', 'story_title', 'status', 'created_date', 'modified_date');
...
//        exit;
    ...
    public function postData() {
        ...
        if($this->input->post('story_comment_id')):
            $this->db->set('story_comment_id', $this->input->post('story_comment_id'));
        endif;
