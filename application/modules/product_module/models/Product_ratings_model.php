...
class Product_ratings_model extends CI_Model {

    private $table = 'product_ratings';
    private $table_view = 'product_ratings_view';
    private $column_order = array(null, 'title', 'value', 'status', 'sort_order', 'created_date', 'modified_date', null);
    private $column_search = array('title', 'value', 'status', 'sort_order', 'created_date', 'modified_date');
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('product_rating_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('product_rating_details');
            endforeach;
        endif;
    }
    ...
    public function details($id) {
        $result = array();
        $this->db->from('product_rating_details');
        $this->db->where('id', $id);
        $query = $this->db->get();
