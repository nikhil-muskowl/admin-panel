...
class Attributes_model extends CI_Model {
    ...
    private $table_view = 'attributes_view';
    private $column_order = array(null, 'group_name', 'title', 'status', 'sort_order', 'created_date', 'modified_date', null);
    private $column_search = array('group_name', 'title', 'status', 'sort_order', 'created_date', 'modified_date');
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('attribute_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('attribute_details');
            endforeach;
        endif;
    }
