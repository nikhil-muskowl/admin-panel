        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2"><?= humanize('product_ratings') ?></label>
                        <div class="col-md-10">
                            <select name="rating_id" id="rating_id" class="form-control">
                                <?php if ($product_ratings): ?> 
                                    <?php foreach ($product_ratings as $value) : ?>
                                        <?php if ($value['id'] == $rating_id): ?>
                                            <option value="<?= $value['id'] ?>" selected><?= $value['title'] ?></option>
                                        <?php else: ?>
                                            <option value="<?= $value['id'] ?>"><?= $value['title'] ?></option>
                                        <?php endif; ?>
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2"><?= humanize('comment') ?></label>
                        <div class="col-md-10">                            
                            <textarea name="comment" placeholder="<?= humanize('comment') ?>" class="form-control"><?= $comment ?></textarea>
                            <span class="help-block"></span>
                        </div>
                    </div> 
