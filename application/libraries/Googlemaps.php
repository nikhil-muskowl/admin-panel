...
class Googlemaps {
    ...
    var $apiKey = 'AIzaSyAOwnKmpn7vyLmrxds1vJXGzSaONvdjgmY';       // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
