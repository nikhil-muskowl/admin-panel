...
class Penalty_reasons_model extends CI_Model {

    private $table = 'penalty_reasons';
    private $table_view = 'penalty_reasons_view';
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('penalty_reason_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('penalty_reason_details');
            endforeach;
        endif;
    }
    ...
    public function details($id) {
        $result = array();
        $this->db->from('penalty_reason_details');
        $this->db->where('id', $id);
        $query = $this->db->get();
