        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2"><?= humanize('penalty_reason') ?></label>
                        <div class="col-md-10">
                            <select name="penalty_reason_id" id="penalty_reason_id" class="form-control">
                                <?php if ($penalty_reasons): ?> 
                                    <?php foreach ($penalty_reasons as $value) : ?>
                                        <?php if ($value['id'] == $penalty_reason_id): ?>
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2"><?= humanize('date') ?></label>
                        <div class="col-md-10">
                            <input name="date" value="<?= $date ?>" placeholder="<?= humanize('date') ?>" id="DatePicker" class="form-control" type="text">
                            <span class="help-block"></span>
                        </div>
                    </div> 
