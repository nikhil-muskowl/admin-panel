...
class Cricket_tournament_levels_model extends CI_Model {

    private $table = 'cricket_tournament_levels';
    private $table_view = 'cricket_tournament_levels';
    private $column_order = array(null, 'name', 'created_date', 'modified_date', null);
    private $column_search = array('name', 'created_date', 'modified_date');
