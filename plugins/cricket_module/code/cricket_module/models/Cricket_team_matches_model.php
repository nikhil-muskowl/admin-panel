...
class Cricket_team_matches_model extends CI_Model {

    private $table = 'cricket_team_matches';
    private $table_view = 'cricket_team_matches_view';
    private $column_order = array(null, 'match_name', 'team_name', 'description', 'created_date', 'modified_date', null);
    private $column_search = array('match_name', 'team_name', 'description', 'created_date', 'modified_date');
