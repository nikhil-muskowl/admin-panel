...
class Cricket_battings_model extends CI_Model {

    private $table = 'cricket_battings';
    private $table_view = 'cricket_battings_view';
    private $column_order = array(null, 'match_name', 'team_name', 'player_name', 'run', 'ball', 'fours', 'sixs', 'created_date', 'modified_date', null);
    private $column_search = array('match_name', 'team_name', 'player_name', 'run', 'ball', 'fours', 'sixs', 'created_date', 'modified_date');
    ...
    public function postData() {
        ...
        $this->db->set('ball', $this->input->post('ball'));
        $this->db->set('fours', $this->input->post('fours'));
        $this->db->set('sixs', $this->input->post('sixs'));
