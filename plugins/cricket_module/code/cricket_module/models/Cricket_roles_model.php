...
class Cricket_roles_model extends CI_Model {

    private $table = 'cricket_roles';
    private $table_view = 'cricket_roles';
    private $column_order = array(null, 'name','short_name', 'created_date', 'modified_date', null);
    private $column_search = array('name','short_name', 'created_date', 'modified_date');
