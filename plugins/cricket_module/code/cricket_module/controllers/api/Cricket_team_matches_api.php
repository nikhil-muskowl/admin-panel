...
class Cricket_team_matches_api extends Restserver\Libraries\REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->cricket_team_matches_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->cricket_team_matches_model->countAll();
        $this->data['recordsFiltered'] = $this->cricket_team_matches_model->countFiltered();
    ...
    public function list_post() {
        ...
        foreach ($list as $object) :
            $action = '';
            $action .= '<a class="btn btn-sm btn-primary" href="' . base_url('cricket_module/cricket_team_matches/form/' . $object['id']) . '" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
    ...
    public function save_post() {
        $this->data = array();
        $this->_validation();
        $result = $this->cricket_team_matches_model->postData();
        if ($result):
            $this->data['status'] = TRUE;
    ...
    public function delete_get($id) {
        $this->data = array();
        $result = $this->cricket_team_matches_model->deleteById($id);
        if ($result) {
            $this->data['status'] = TRUE;
