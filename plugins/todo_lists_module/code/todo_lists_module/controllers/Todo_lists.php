...
class Todo_lists extends MX_Controller {
    ...
    public function index() {
        ...
        $this->data['ajax_send_mail'] = base_url('todo_lists_module/api/todo_lists_api/send_mail');
        ...
        $this->load->view('todo_lists_module/todo_lists/list', $this->data);
        $this->load->view('admin/common/footer', $this->data);
    }

    public function form($id = NULL) {
        $this->data = array();
        $result = $this->todo_lists_model->getById($id);
        ...
        $this->data['ajax_list'] = base_url('todo_lists_module/todo_lists');
        $this->data['ajax_save'] = base_url('todo_lists_module/api/todo_lists_api/save');
        $this->data['ajax_date_days'] = base_url('todo_lists_module/api/todo_lists_api/dateToDay');
        ...
        $this->load->view('admin/common/navbar', $this->data);
        $this->load->view('admin/common/sidebar', $this->data);
        $this->load->view('todo_lists_module/todo_lists/form', $this->data);
