...
class User_devices_model extends CI_Model {
    ...
    private $table_view = 'user_devices_view';
    private $column_order = array(null, 'user_name', 'provider', 'type', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('user_name', 'provider', 'type', 'status', 'created_date', 'modified_date');
...
//        exit;
    ...
    public function register() {
        ...
        $user_device = $this->db->get_where('user_devices', $userDeviceFilter)->row_array();
