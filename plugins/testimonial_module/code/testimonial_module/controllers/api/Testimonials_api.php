...
class Testimonials_api extends Restserver\Libraries\REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->testimonials_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->testimonials_model->countAll();
        $this->data['recordsFiltered'] = $this->testimonials_model->countFiltered();
    ...
    public function list_post() {
        ...
        foreach ($list as $object) :
            $action = '';
            $action .= '<a class="btn btn-sm btn-primary" href="' . base_url('testimonial_module/testimonials/form/' . $object['id']) . '" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
    ...
    public function detail_get($id) {
        $this->data = array();
        $object = $this->testimonials_model->getById($id);
        if ($object):
            $result[] = array(
                'id' => $object['id'],
                'author' => $object['author'],
    ...
    public function save_post() {
        $this->data = array();
        $this->_validation();
        $result = $this->testimonials_model->postData();
        if ($result):
            $this->data['status'] = TRUE;
    ...
    public function delete_get($id) {
        $this->data = array();
        $result = $this->testimonials_model->deleteById($id);
        if ($result) {
            $this->data['status'] = TRUE;
