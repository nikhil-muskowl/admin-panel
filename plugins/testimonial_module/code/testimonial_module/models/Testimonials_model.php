...
class Testimonials_model extends CI_Model {
    ...
    private $table_view = 'testimonials';
    private $column_order = array(null, 'author', 'role', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('author', 'role', 'status', 'created_date', 'modified_date');
