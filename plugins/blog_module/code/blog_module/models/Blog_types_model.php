...
class Blog_types_model extends CI_Model {

    private $table = 'blog_types';
    private $table_view = 'blog_types_view';
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('blog_type_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('blog_type_details');
            endforeach;
        endif;
    }
    ...
    public function details($id) {
        $result = array();
        $this->db->from('blog_type_details');
        $this->db->where('id', $id);
        $query = $this->db->get();
