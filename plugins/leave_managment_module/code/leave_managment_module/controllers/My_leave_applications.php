...
class My_leave_applications extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->lang->load('my_leave_applications', $this->languages_lib->getLanguage());
    ...
    public function index() {
        $this->data = array();
        $this->data['ajax_list'] = base_url('leave_managment_module/api/my_leave_applications_api/list');
        $this->data['ajax_delete'] = base_url('leave_managment_module/api/my_leave_applications_api/delete');
        $this->data['ajax_preview'] = base_url('leave_managment_module/api/my_leave_applications_api/preview');
        $this->data['ajax_send'] = base_url('leave_managment_module/api/my_leave_applications_api/send');
        $this->data['ajax_form'] = base_url('leave_managment_module/my_leave_applications/form');
        ...
        $this->load->view('leave_managment_module/my_leave_applications/list', $this->data);
        $this->load->view('admin/common/footer', $this->data);
    }

    public function form($id = NULL) {
        $this->data = array();
        $result = $this->my_leave_applications_model->getById($id);
        ...
        $this->data['ajax_list'] = base_url('leave_managment_module/my_leave_applications');
        $this->data['ajax_save'] = base_url('leave_managment_module/api/my_leave_applications_api/save');
        $this->data['ajax_date_days'] = base_url('leave_managment_module/api/my_leave_applications_api/dateToDay');
        ...
        $this->load->view('admin/common/navbar', $this->data);
        $this->load->view('admin/common/sidebar', $this->data);
        $this->load->view('leave_managment_module/my_leave_applications/form', $this->data);
