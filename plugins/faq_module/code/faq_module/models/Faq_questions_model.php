...
class Faq_questions_model extends CI_Model {

    private $table = 'faq_questions';
    private $table_view = 'faq_questions_view';
    private $detail_table = 'faq_question_details';
    private $column_order = array(null, 'text', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('text', 'status', 'created_date', 'modified_date');
    private $order = array('text' => 'asc');
    private $status;
    private $language_id;
    ...
    public function postDetails($id) {
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->set('text', $value['text']);
                $this->db->insert('faq_question_details');
            endforeach;
        endif;
    }
