...
class Faq_answers_model extends CI_Model {

    private $table = 'faq_answers';
    private $table_view = 'faq_answers_view';
    private $detail_table = 'faq_answer_details';
    ...
    public function postDetails($id) {
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('faq_answer_details');
            endforeach;
        endif;
    }
