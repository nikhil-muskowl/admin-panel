...
class Attribute_groups_model extends CI_Model {
    ...
    private $table_view = 'attribute_groups_view';
...
//        exit;
    ...
    public function postDetails($id) {
        $this->db->where('id', $id);
        $this->db->delete('attribute_group_details');
        ...
        if ($this->input->post('details')):
            foreach ($this->input->post('details') as $key => $value) :
                ...
                $this->db->insert('attribute_group_details');
            endforeach;
        endif;
    }
    ...
    public function details($id) {
        $result = array();
        $this->db->from('attribute_group_details');
        $this->db->where('id', $id);
        $query = $this->db->get();
