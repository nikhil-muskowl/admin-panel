...
class Product_reviews_model extends CI_Model {
    ...
    private $table_view = 'product_reviews_view';
    private $column_order = array(null, 'product', 'author', 'rating_text', 'rating', 'date', null);
    private $column_search = array('product', 'author', 'rating_text', 'rating', 'date');
...
//        exit;
    ...
    public function postData() {
        ...
        $this->db->set('rating_id', $this->input->post('rating_id'));
