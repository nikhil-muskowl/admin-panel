...
class Addresses_model extends CI_Model {
    ...
    private $table_view = 'addresses_view';
    private $column_order = array(null, 'country', 'zone', 'name', 'contact', 'status', 'created_date', 'modified_date', null);
    private $column_search = array('country', 'zone', 'name', 'contact', 'status', 'created_date', 'modified_date');
