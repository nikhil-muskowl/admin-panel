...
class Inquiries_api extends Restserver\Libraries\REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->inquiries_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->inquiries_model->countAll();
        $this->data['recordsFiltered'] = $this->inquiries_model->countFiltered();
    ...
    public function list_post() {
        ...
        foreach ($list as $object) :
            $action = '';
            $action .= '<a class="btn btn-sm btn-primary" href="' . base_url('inquiry_module/inquiries/form/' . $object['id']) . '" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
    ...
    public function detail_get($id) {
        ...
        $object = $this->inquiries_model->getById($id);
    ...
    public function save_post() {
        $this->data = array();
        $this->_validation();
        $result = $this->inquiries_model->postData();
        if ($result):
            $this->data['status'] = TRUE;
    ...
    public function delete_get($id) {
        $this->data = array();
        $result = $this->inquiries_model->deleteById($id);
        if ($result) {
            $this->data['status'] = TRUE;
