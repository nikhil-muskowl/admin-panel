...
class product_wishlists extends MX_Controller {
    ...
    public function index() {
        $this->data = array();
        $this->data['ajax_list'] = base_url('product_module/api/product_wishlists_api/list');
        $this->data['ajax_delete'] = base_url('product_module/api/product_wishlists_api/delete');
        $this->data['ajax_form'] = base_url('product_module/product_wishlists/form');
        ...
        $this->load->view('product_wishlists/list', $this->data);
        $this->load->view('admin/common/footer', $this->data);
    }

    public function form($id = NULL) {
        $this->data = array();
        $result = $this->product_wishlists_model->getById($id);
        ...
        $this->data['ajax_list'] = base_url('product_module/product_wishlists');
        $this->data['ajax_save'] = base_url('product_module/api/product_wishlists_api/save');
        $this->data['ajax_image_form'] = base_url('product_module/product_wishlists/image_form/');
        ...
        $this->load->view('admin/common/navbar', $this->data);
        $this->load->view('admin/common/sidebar', $this->data);
        $this->load->view('product_wishlists/form', $this->data);
