...
class Product_carts_api extends Restserver\Libraries\REST_Controller {
    ...
    public function index_post() {
        ...
        $list = $this->product_carts_model->getTables();
        ...
        $this->data['recordsTotal'] = $this->product_carts_model->countAll();
        $this->data['recordsFiltered'] = $this->product_carts_model->countFiltered();
    ...
    public function list_post() {
        ...
        foreach ($list as $object) :
            $action = '';
            $action .= '<a class="btn btn-sm btn-primary" href="' . base_url('product_module/product_carts/form/' . $object['id']) . '" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil"></i></a>';
    ...
    public function detail_get($id) {
        $this->data = array();
        $object = $this->product_carts_model->getById($id);
        if ($object):
            $result[] = array(
                'id' => $object['id'],
                'product_name' => $object['product_name'],
    ...
    public function save_post() {
        $this->data = array();
        $this->_validation();
        $result = $this->product_carts_model->postData();
        if ($result):
            $this->data['status'] = TRUE;
    ...
    public function _validation() {
        ...
        $this->form_validation->set_rules('product_id', 'product', 'required|callback_validate_cart');
    ...
    public function validate_cart($field_value) {
        if ($this->product_carts_model->checkCart($field_value)) {
            $this->form_validation->set_message('validate_cart', '{field} already in cart!');
            return FALSE;
        } else {
            return TRUE;
        }
    ...
    public function delete_get($id) {
        $this->data = array();
        $result = $this->product_carts_model->deleteById($id);
        if ($result) {
            $this->data['status'] = TRUE;
