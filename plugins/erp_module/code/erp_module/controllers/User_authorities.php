...
class User_authorities extends MX_Controller {
    ...
    public function __construct() {
        ...
        $this->lang->load('user_authorities', $this->languages_lib->getLanguage());
        $this->meta_title = humanize(__CLASS__);
        $this->load->model('erp_module/user_authorities_model');
    }

    public function index() {
        $this->data = array();
        $this->data['ajax_list'] = base_url('erp_module/api/user_authorities_api/list');
        $this->data['ajax_delete'] = base_url('erp_module/api/user_authorities_api/delete');
        $this->data['ajax_form'] = base_url('erp_module/user_authorities/form');
        ...
        $this->load->view('erp_module/user_authorities/list', $this->data);
        $this->load->view('admin/common/footer', $this->data);
    }

    public function form($id = NULL) {
        $this->data = array();
        $result = $this->user_authorities_model->getById($id);
        ...
        $this->data['ajax_list'] = base_url('erp_module/user_authorities');
        $this->data['ajax_save'] = base_url('erp_module/api/user_authorities_api/save');
        ...
        $this->load->view('admin/common/navbar', $this->data);
        $this->load->view('admin/common/sidebar', $this->data);
        $this->load->view('erp_module/user_authorities/form', $this->data);
