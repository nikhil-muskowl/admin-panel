...
class Services extends MX_Controller {
    ...
    public function index() {
        $this->data = array();
        $this->data['ajax_list'] = base_url('service_module/api/services_api/list');
        $this->data['ajax_delete'] = base_url('service_module/api/services_api/delete');
        $this->data['ajax_form'] = base_url('service_module/services/form');
        ...
        $this->load->view('services/list', $this->data);
        $this->load->view('admin/common/footer', $this->data);
    }

    public function form($id = NULL) {
        $this->data = array();
        $result = $this->services_model->getById($id);
        ...
        $this->data['product_services'] = $this->services_model->getTables();
        ...
        $details = $this->services_model->details($id);
        ...
        $url_alias = $this->services_model->getUrlAlias($id);
        ...
        $this->data['ajax_list'] = base_url('service_module/services');
        $this->data['ajax_save'] = base_url('service_module/api/services_api/save');
        $this->data['ajax_image_form'] = base_url('service_module/services/image_form/');
        ...
        $this->load->view('admin/common/navbar', $this->data);
        $this->load->view('admin/common/sidebar', $this->data);
        $this->load->view('services/form', $this->data);
